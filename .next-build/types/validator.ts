...
// Validate ../../app/api/predictions/match/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/predictions/match">> = Specific
  const handler = {} as typeof import("../../app/api/predictions/match/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/api/predictions/tournament/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/predictions/tournament">> = Specific
  const handler = {} as typeof import("../../app/api/predictions/tournament/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
